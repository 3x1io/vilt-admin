...
class LoaderController extends Controller
{
    ...
    {
        return [
                                Row::make('id')->label(__('loaders.id'))->create(false)->edit(false)->get(),
        
                        Row::make('start_date')->label(__('loaders.start_date'))->type('datetime')->get(),
        
                        Row::make('end_date')->label(__('loaders.end_date'))->type('datetime')->get(),
        
                        Row::make('time')->label(__('loaders.time'))->type('time')->get(),
