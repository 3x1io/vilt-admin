...
class CustomersLocationController extends Controller
{
    ...
    {
        return [
                                Row::make('id')->label(__('customers_locations.id'))->create(false)->edit(false)->get(),
        
                        Row::make('customer_id')->label('customer')->type('hasOne')->list(false)->options(\App\Models\Customer::all()->toArray())->get(),
                
                        Row::make('address')->label(__('customers_locations.address'))->type('textarea')->get(),
        
                        Row::make('country')->label(__('customers_locations.country'))->get(),
        
                        Row::make('city')->label(__('customers_locations.city'))->get(),
        
                        Row::make('area')->label(__('customers_locations.area'))->get(),
        
                        Row::make('home')->label(__('customers_locations.home'))->type('number')->get(),
        
                        Row::make('flat')->label(__('customers_locations.flat'))->type('number')->get(),
        
                        Row::make('floor')->label(__('customers_locations.floor'))->type('number')->get(),
        
                        Row::make('active')->label(__('customers_locations.active'))->type('switch')->get(),
