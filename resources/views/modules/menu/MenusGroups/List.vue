    ...
    <app-layout :title="trans('menus_groups.title')">
        <div class="px-6 mx-auto pt-6">
            <Header
                ...
                :button="trans('menus_groups.create')"
                @buttonAction="create"
            >
            </Header>
        ...
        <CreateModal
            ...
            :title="
                edit
                    ? trans('menus_groups.edit.title')
                    : trans('menus_groups.create.title')
            "
            :show="createModal"
            :edit="edit"
            :errors="errors"
        ...
        <DeleteModal
            :url="url"
            :title="trans('menus_groups.delete')"
            :show="deleteModal"
            :item="form"
