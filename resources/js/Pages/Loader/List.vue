<template>
    <app-layout title="Loader">
        <div class="px-6 mx-auto">
            <Header :canCreate="$attrs.canCreate" title="Loader" button="Create Loader"
                @buttonAction="create">
            </Header>
        ...
        <br>
        <br>
        <CreateModal :url="url" title="Loader" :show="createModal" :edit="edit" :errors="errors" :item="form"
            :rows="rows" @close="createModal = !createModal" @success="success" />
        <ViewModal title="View Loader" :show="viewModal" :item="form" :rows="rows"
            @close="viewModal = !viewModal" />
        <DeleteModal :url="url" title="Delete Loader" :show="deleteModal" :item="form"
            @close="deleteModal = !deleteModal" @success="success" />
        <BulkModal :url="url" title="Bulk Action On Loader" :action="bulkActionTitle" :bulk="bulk"
