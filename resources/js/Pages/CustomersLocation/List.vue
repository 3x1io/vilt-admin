<template>
    <app-layout title="Customers Location">
        <div class="px-6 mx-auto">
            <Header :canCreate="$attrs.canCreate" title="CustomersLocation" button="Create CustomersLocation"
                @buttonAction="create">
            </Header>
        ...
        <br>
        <br>
        <CreateModal :url="url" title="CustomersLocation" :show="createModal" :edit="edit" :errors="errors" :item="form"
            :rows="rows" @close="createModal = !createModal" @success="success" />
        <ViewModal title="View CustomersLocation" :show="viewModal" :item="form" :rows="rows"
            @close="viewModal = !viewModal" />
        <DeleteModal :url="url" title="Delete CustomersLocation" :show="deleteModal" :item="form"
            @close="deleteModal = !deleteModal" @success="success" />
        <BulkModal :url="url" title="Bulk Action On CustomersLocation" :action="bulkActionTitle" :bulk="bulk"
