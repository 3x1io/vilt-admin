<template>
    <app-layout :title="trans('users.title')">
        <div class="container grid px-6 mx-auto">
            <Header
                :canCreate="$attrs.canCreate"
                :title="trans('users.title')"
                :button="trans('users.create')"
                @buttonAction="create"
            >
            </Header>
        ...
        <CreateModal
            :url="url"
            :title="edit ? trans('users.edit.title') : trans('users.create.title')"
            :show="createModal"
            :edit="edit"
            :errors="errors"
            :item="form"
