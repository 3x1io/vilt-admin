...
class UserController extends BaseController
{
    ...
    public function schema()
    {
        return [
            ...
            Row::make('email')->label(__('Email'))->type('email')->get(),
            Row::make('password')->label(__('Password'))->type('password')->list(false)->view(false)->get(),
            Row::make('password_confirmation')->label(__('Password Confirmation'))->type('password')->list(false)->view(false)->get(),
            Row::make('roles')->label(__('Roles'))->type('relation')->options(Role::all()->toArray())->multi(true)->sorting(false)->get(),
    ...
    public function store(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $recordData['password'] = bcrypt($recordData['password']);
